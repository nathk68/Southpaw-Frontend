  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setError(data.error || (t.loginModal.discordDesc));
      }
    } catch (err) {
